...
def mainGame(movementInfo):
    ...
    while True:
        catlist = [p['x'] for p in upperPipes] + \
                  [p['y'] for p in upperPipes] + \
                  [p['x'] for p in lowerPipes] + \
                  [p['y'] for p in lowerPipes]
        catlist.extend([playery,
                basex,
                score,
                playerVelY])
